    ...
    **/
    ...
    _chart._brushing = function() {
        ...
        if (_chart.brushIsEmpty(extent)) {
            ...
            var rangedFilter = dc.filters.RangedFilter(extent[0], extent[1], _chart.xAxisMax() == extent[1] || _chart.xAxisMax() == (_chart.xUnits().resolution + extent[1])); // now inclusive of xAxisMax
