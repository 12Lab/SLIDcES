...
/**
#### Version 1.6.99-dev-tableHeaders-rowIgnore-Stats
...
dc.filters.RangedFilter = function(low, high, bInclusiveHigh) {
    ...
    range.isFiltered = function(value) {
        return value >= this[0] && ( ( this[2] ? value <= this[1] : value < this[1]));
    };
    ...
    **/
    ...
    _chart._brushing = function() {
        ...
        if (_chart.brushIsEmpty(extent)) {
            ...
            // temp workaround, when using .xUnits(dc.units.fp.precision(p))
...
dc.rowChart = function (parent, chartGroup) {
    ...
    **/
    ...
    _chart.ignoreZeroValue = function(x,v,k){
        if(!arguments.length) return _ignoreZeroValue;
        _ignoreZeroValue = x;
        _ignoreValuesBelow = v === undefined ? 1 : v;
        _ignoreKey = k === undefined ? null : k;
        return _chart;
    };
